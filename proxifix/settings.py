"""
Django settings for proxifix project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-+t-*l12a#+uciwiny#x)-)=2v@2c-ie%-u28!l!zx7ma3c-499')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'testserver', 'http://proxifix.onrender.com/']
...
WSGI_APPLICATION = 'proxifix.wsgi.application'
